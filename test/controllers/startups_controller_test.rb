...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post startups_url, params: { startup: { : @startup., description: @startup.description, duration: @startup.duration, price: @startup.price, start_date: @startup.start_date, title: @startup.title } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { : @startup., description: @startup.description, duration: @startup.duration, price: @startup.price, start_date: @startup.start_date, title: @startup.title } }
